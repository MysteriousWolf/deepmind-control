...
One, and it is not a drawing. Six of the seven rows this file carried closed in
26.5, and the seventh closed as far as it can until somebody puts a meter on the
instrument.
